                      ...
                      <div className="px-4 sm:px-6">
                        <div className="flex items-start justify-end">
                          <div className="ml-3 flex h-7 items-center">
                            <button onClick={props.onClose} className="rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2">
                              ...
                              {props.data.isGroup && (
                                <div>
                                  ...
                                  <dd className="mt-1 text-sm text-gray-900 sm:col-span-2">
                                    {props.data.users.map((user) => user.email).join(', ')}
                                  </dd>
                                </div>
                              )}
                              {!props.data.isGroup && (
